...
// pod repo push  git@github.com:NimbleEdge/iOS-SDK.git NimbleEdgeSwiftySyft.podspec
...
public class SyftClient: SyftClientProtocol {
    ...
    public func saveModel(_ data: Data) {
        UserDefaults.standard.set(data, forKey: "modelData")
    }
