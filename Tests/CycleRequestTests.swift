...
//
//        self.cycleAcceptClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: false)!
//        self.cycleAcceptJob = self.cycleAcceptClient.newJob(modelName: "mnist", version: "1.0", inference: false)
//
...
//    }
    ...
    func testCycleRejected() {
        ...
        self.cycleRejectClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: false)!
        self.cycleRejectJob = self.cycleRejectClient.newJob(modelName: "mnist", version: "1.0", inference: false)
    ...
    func testCycleRejectedWithTimeout() {
        ...
        self.cycleRejectTimeoutClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: false)!
        self.cycleRejectTimeoutJob = self.cycleRejectTimeoutClient.newJob(modelName: "mnist", version: "1.0", inference: false)
