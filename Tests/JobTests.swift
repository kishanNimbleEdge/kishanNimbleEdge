...
//
//        self.oneJobClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: true)!
//        self.oneJobJob = self.oneJobClient.newJob(modelName: "mnist", version: "1.0", inference: true)
//
...
//
//        self.multipleJobClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: true)!
//        self.multipleJobOne = self.multipleJobClient.newJob(modelName: "mnist", version: "1.0", inference: true)
//        self.multipleJobTwo = self.multipleJobClient.newJob(modelName: "mnist", version: "1.0", inference: true)
//
...
//
//        self.diffReportClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: true)!
//        self.diffReportJob = self.diffReportClient.newJob(modelName: "mnist", version: "1.0", inference: true)
//
...
//                                      modelName: "model",version: "1.0",authToken: nil, inference: true,batteryChargeCheck: { return true },
//         wifiCheck: { _,_ in
...
//                                      modelName: "model",version: "1.0",authToken: nil, inference: true,batteryChargeCheck: { return false },
//         wifiCheck: { _,_ in
//            return Future<Bool, Never> { promise in
//                promise(.success(true))
//                // promise(.success(false))
