...
public class SyftMode: NSCoder {
    let syftModel: SyftModel
    init(syftModel: SyftModel) {
        self.syftModel = syftModel
    }
}

public class SyftModel: NSObject {

    public let modelState: SyftProto_Execution_V1_State
