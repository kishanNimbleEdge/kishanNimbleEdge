...
class WebSocketAuthentication: XCTestCase {
    ...
    func testNoAuth() {
        ...
        self.noAuthJob = SyftJob(connectionType: .socket(url: url, sendMessageSubject: self.noAuthSendMessageSubject, receiveMessagePublisher: receiveMessagePublisher), modelName: "MNIST", version: "1.0", inference: false)
    ...
    func testWithAuthNoToken() {
        ...
        self.noTokenJob = SyftJob(connectionType: .socket(url: url, sendMessageSubject: self.noTokenSendMessageSubject, receiveMessagePublisher: receiveMessagePublisher), modelName: "MNIST", version: "1.0", inference: false)
    ...
    func testWithInvalidToken() {
        ...
        self.invalidTokenJob = SyftJob(connectionType: .socket(url: url, sendMessageSubject: self.invalidTokenSendMessageSubject, receiveMessagePublisher: receiveMessagePublisher), modelName: "MNIST", version: "1.0", inference: false)
    ...
    func testWithValidToken() {
        ...
        self.validTokenJob = SyftJob(connectionType: .socket(url: url, sendMessageSubject: self.validTokenSendMessageSubject, receiveMessagePublisher: receiveMessagePublisher), modelName: "MNIST", version: "1.0", inference: false)
