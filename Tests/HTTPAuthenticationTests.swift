...
class HTTPAuthenticationTests: XCTestCase {
    ...
    func testNoAuth() {
        ...
        self.noAuthClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: false)!
        self.noAuthJob = self.noAuthClient.newJob(modelName: "mnist", version: "1.0", inference: false)
    ...
    func testWithAuthNoToken() {
        ...
        self.noTokenClient = SyftClient(url: URL(string: "http://test.com:3000")!, inference: false)!
        self.noTokenJob = self.noTokenClient.newJob(modelName: "mnist", version: "1.0", inference: false)
    ...
    func testWithAuthInvalidToken() {
        ...
        self.invalidTokenClient = SyftClient(url: URL(string: "http://test.com:3000")!,
                                             authToken: "incorrect-token", inference: false)!
        self.invalidTokenJob = self.invalidTokenClient.newJob(modelName: "mnist", version: "1.0", inference: false)
    ...
    func testWithAuthValidToken() {
        ...
        self.validTokenClient = SyftClient(url: URL(string: "http://test.com:3000")!,
                                           authToken: "correct-token", inference: false)!
        self.validTokenJob = self.validTokenClient.newJob(modelName: "mnist", version: "1.0", inference: false)
